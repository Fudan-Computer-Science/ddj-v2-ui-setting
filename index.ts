import { Context, SettingModel, Handler } from 'hydrooj';



export async function apply(ctx: Context) {
	ctx.Route('docs_homepage', '/homepage', Handler);
	ctx.injectUI('Nav', 'docs_homepage', {url: '/homepage', before: 'problem_main'});
